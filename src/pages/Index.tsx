...
const Index = () => {
  const images = ['banner/p1.webp', 'banner/p2.webp', 'banner/p3.webp', 'banner/p4.webp'];
  const gallist = ['/lovable-uploads/0cc8fc65-015b-45f8-ac1b-99083f6300e3.png', '/lovable-uploads/904454cb-68d7-46ca-9ca5-e1055ee8a325.png', '/lovable-uploads/023319cf-1943-40d0-a6e5-ed30a06c6306.png', '/lovable-uploads/099ddc2e-d2fe-49a0-bbf1-12d8bf842651.png', '/lovable-uploads/3f6fe587-d6e6-4e7d-9bad-d5e1347e7f06.png', '/lovable-uploads/9e0f9f34-8c6a-4590-b566-2c5f2b8c5b3f.png', '/lovable-uploads/de6180e4-7a83-4302-80a8-6c42fc7a85a4.png'];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="bg-white rounded-3xl p-6 shadow-sm">
              ...
              <h2>Primer nivel: Para taller, bodega, oficinas. Y garage.</h2>
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="bg-white rounded-3xl p-6 shadow-sm">
              ...
              <Button onClick={handleWhatsAppClick} className="w-full bg-green-500 hover:bg-green-600 text-white flex items-center justify-center gap-2">
