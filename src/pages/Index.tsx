...
const Index = () => {
  ...
  const schemaData = {
    ...
    "description": "Local Comercial en Renta. Para taller, bodega, oficinas.",
    "address": {
      "@type": "PostalAddress",
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC]">
      <Helmet>
        ...
        <meta name="description" content="Local Comercial en Renta. Para taller, bodega, oficinas." />
      </Helmet>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="bg-white rounded-3xl p-6 shadow-sm">
              ...
              <h2>Para taller, bodega, oficinas.</h2>
